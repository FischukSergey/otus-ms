...
INSERT INTO news_sources (id, name, url, language, category, fetch_interval) VALUES
    ('source_1',  'Lenta.ru',              'https://lenta.ru/rss/news',                                                     'ru', 'news',     3600),
    ('source_2',  'RBC Новости',           'https://rssexport.rbc.ru/rbcnews/news/30/full.rss',                             'ru', 'news',     1800),
    ...
    ('source_8',  'Ведомости',             'https://www.vedomosti.ru/rss/news.xml',                                         'ru', 'news',     1800),
